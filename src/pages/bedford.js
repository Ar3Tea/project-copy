  ...
  <Layout>
    ...
    >
      ...
      <div className="container text-center text-white mt-2">
        <div className="row">
          <div className="col">
            <h1 className="venue-header">Bedford Hall</h1>
          </div>
        </div>
        <div className="container pt-5">
          ...
          <div className="row mt-5">
            <div className="col-md-6 col-sm-12 pt-2">
              <img
                className="venue-img"
                src={require("../images/bedfordhall.jpg")}
                alt="venue-img"
              />
            </div>
            <div className="col-md-6 col-sm-12 pt-2">
              <iframe
              title="venue map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2422.0276395194983!2d-0.10894528399544232!3d52.62334463631719!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4877f950f6bf8fbf%3A0x370fe04d617b6eac!2sBedford+Hall!5e0!3m2!1sen!2suk!4v1552405060280"
                width={500}
                height={350}
                frameborder={0}
                style={{ border: 0 }}
